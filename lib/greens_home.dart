...
class GreensHomeScreen extends StatefulWidget {
  const GreensHomeScreen({Key key}) : super(key: key);

  @override
  GreensHomeScreenState createState() => GreensHomeScreenState();
}

class GreensHomeScreenState extends State<GreensHomeScreen> {
                 ...
                 children: <Widget>[
                   Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        getImageAsset('images/shops/greens.png'),
               ...
               Column(
                 children: <Widget>[
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                             Text("CART"),
                              getImageAsset('images/shops/cart.png'),
                      ],
                    )
                  ),
                 ],
